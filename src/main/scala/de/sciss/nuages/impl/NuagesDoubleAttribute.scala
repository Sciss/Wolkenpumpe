...
object NuagesDoubleAttribute extends NuagesAttribute.Factory {
  ...
  def apply[S <: Sys[S]](key: String, obj: DoubleObj[S], parent: NuagesObj[S])
...
final class NuagesDoubleAttribute[S <: Sys[S]](val parent: NuagesObj[S], val key: String, val spec: ParamSpec,
