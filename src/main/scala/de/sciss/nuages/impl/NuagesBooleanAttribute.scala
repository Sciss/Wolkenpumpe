...
object NuagesBooleanAttribute extends NuagesAttribute.Factory {
  ...
  def apply[S <: Sys[S]](key: String, obj: BooleanObj[S], parent: NuagesObj[S])
...
final class NuagesBooleanAttribute[S <: Sys[S]](val parent: NuagesObj[S], val key: String, val spec: ParamSpec,
