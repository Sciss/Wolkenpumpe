...
//
//  def startListening(implicit txn: ProcTxn): Unit =
//    ProcDemiurg.addListener(this)
//
//  def stopListening(implicit txn: ProcTxn): Unit =
//    ProcDemiurg.removeListener(this)
//
//  private def groupByAnatomy(set: Set[ProcFactory]): Map[ProcAnatomy, Set[ProcFactory]] = {
//    val filtered = set.filterNot(f => {
//      val c = f.name.charAt(0); c == '$' || c == '_'
//    })
...
//    })
//
//  def updated(u: ProcDemiurg.Update): Unit =
//    defer {
